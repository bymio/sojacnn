  ...
  <div>
    <el-card shadow="hover">
      ...
      <el-tabs v-model="addParams.contypeId" @tab-click="handleClick">
        <el-tab-pane
          v-for="(item, id) in newsXing"
          :key="id"
          :label="item.contypeName"
          :name="item.id.toString()"
        >
          <el-button class="bieButton" type="primary" @click="addNewsBie()"
            >添加新闻类别</el-button
          >
          <el-table
            :data="newsBie"
          ...
          >
            ...
            <el-table-column prop="categoryName" label="新闻类别">
            </el-table-column>
    ...
    <el-dialog title="提示" :visible.sync="addNewsBieDialog" width="30%">
      ...
      <el-input
        v-model="addParams.categoryName"
        placeholder="请填写新闻类别"
      ></el-input>
    ...
    <el-dialog title="提示" :visible.sync="editNewsBieDialog" width="30%">
      ...
      <el-input
        v-model="editParams.categoryName"
        placeholder="请重新填写新闻类别"
      ></el-input>
      <span slot="footer" class="dialog-footer">
